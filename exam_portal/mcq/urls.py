...
from . import views
from mcq import views as mcq_views

urlpatterns = [
    # --- Home and Dashboard ---
    path('', views.home, name='home'),           # For everyone (public home page)
    path('dashboard_redirect/', views.home, name='dashboard_redirect'),  # Redirects based on user role
    ...
    path('download_quiz_pdf/', views.download_quiz_pdf, name='download_quiz_pdf'),
